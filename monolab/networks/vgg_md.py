...
class VGGMonodepth(nn.Module):  # vgg version
    ...
    def forward(self, x):
        ...
        concat_3 = torch.cat(
            [upconv_3, conv_2, udisp4], 1
        )  # 130x64x128
        iconv_3 = self.conv_3(concat_3)  # 64x64x128
        self.disp3 = 0.3 * self.get_disp3(
            iconv_3
        )  # 2x64x128
        ...
        concat_2 = torch.cat(
            [upconv_2, conv_1, udisp3], 1
        )  # 66x128x256
        iconv_2 = self.conv_2(concat_2)  # 32x128x256
        self.disp2 = 0.3 * self.get_disp2(
            iconv_2
        )  # 2x128x256
